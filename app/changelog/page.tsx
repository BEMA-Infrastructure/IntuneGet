...
const releases: Release[] = [
  {
    version: "0.5.0",
    date: "2026-02-01",
    title: "PSADT v4 UI Elements & Enhanced Landing",
    type: "minor",
    highlights: [
      "Added comprehensive PSADT v4 UI elements support for deployment scripts",
      "Integrated live GitHub statistics into Hero and Trust sections",
      "Enhanced landing page with comparison section and mission statement",
      "Improved metadata and SEO with structured data markup",
      "Added Docker self-hosting documentation",
    ],
  },
  {
    version: "0.4.0",
